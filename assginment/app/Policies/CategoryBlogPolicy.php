...
class CategoryBlogPolicy
{
    ...
    {
        return $user->can('view_any_categories::blog');
    }
    ...
    {
        return $user->can('view_categories::blog');
    }
    ...
    {
        return $user->can('create_categories::blog');
    }
    ...
    {
        return $user->can('update_categories::blog');
    }
    ...
    {
        return $user->can('delete_categories::blog');
    }
