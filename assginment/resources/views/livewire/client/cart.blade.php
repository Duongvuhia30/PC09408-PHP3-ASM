...
<section class="section mobile-tab" id="product-tab" data-title=" Có thể bạn sẽ thích">
	<div class="container card py-md-4 px-md-4">
		<div class="title_module  heading-bar d-none d-sm-flex justify-content-between align-items-center">
			<h2 class="bf_flower heading-bar__title">
				<a class="link" href="new-arrival.html" title=" Có thể bạn sẽ thích"> Có thể bạn sẽ thích</a>
			</h2>
		</div>
	...
	<div class='cart-upsell__promotion-wrapper'>
		<div class='cart-upsell__promotion'
			 style='border-width: 1px;
					...
					color: #dc7322;
					background: #feeee2;'>
						<img src='//bizweb.dktcdn.net/100/484/026/themes/953543/assets/cart_upsell_coupon.png?1738827047187' alt='cart-upsell'/>
...
Vui lòng chọn mua thêm sản phẩm
		...
		<div class="cart-cta">
			...
			<img loading="lazy" src="//bizweb.dktcdn.net/100/484/026/themes/953543/assets/delivery-icon.png?1738827047187" alt="delivery" ->
