...
Áo khoác thể thao phù hợp với mọi đối tượng từ nam giới, nữ giới, người già, trẻ em cho đến những người mới bắt đầu tập luyện hay những người có kinh nghiệm trong tập luyện. Với thiết kế đa dạng và phong phú, áo khoác thể thao giúp người dùng tạo nên phong cách thời trang riêng và thể hiện sự chuyên nghiệp trong quá trình tập luyện.">
	...
	<div class="d-none hidden" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
		...
		<meta itemprop="url" content="https://ega-sportswear.mysapo.net/san-pham-demo-coupon-nhap-lieu-tu-metafield">
	...
	<div class="d-none hidden" id="https://ega-sportswear.mysapo.net" itemprop="seller" itemtype="http://schema.org/Organization" itemscope>
		<meta itemprop="name" content="EGA Sportswear" />
		<meta itemprop="url" content="https://ega-sportswear.mysapo.net" />
					 ...
					 <i class="float-right">
						<svg class="icon">
							<use xlink:href="#icon-arrow"></use>
										...
										<div class='content'>
						<p>EGA Sportswear&nbsp;có dịch vụ giao hàng tận nơi trên toàn quốc, áp dụng cho khách mua hàng trên website, fanpage và gọi điện thoại, không áp dụng cho khách mua trực tiếp tại cửa hàng.</p><p>Đơn hàng sẽ được chuyển phát đến tận địa chỉ khách hàng cung cấp thông qua công ty vận chuyển trung gian.</p><p><br>1.&nbsp;<strong>Thời gian giao hàng</strong>:</p><ul><li>Đơn hàng nội và ngoại thành TP.HCM:</li></ul><p>Thời gian giao hàng là 1-2 ngày sau khi đặt hàng.</p><p>Đơn hang trước 11h30 trưa thì sẽ giao trong buổi chiều cùng ngày</p><p>Đơn hàng sau 11h30 sẽ giao trong buổi tối và sáng hôm sau.</p><ul><li>Đơn hàng ở các tỉnh thành khác:</li></ul><p>Thời gian là 2-3 ngày đối với khu vực trung tâm tỉnh thành phố, 3-7 ngày đối với khu vực ngoại thành, huyện, xã, thị trấn…</p><p>(Không tính thứ bảy, chủ nhật hay các ngày lễ tết)</p><p>Thời gian xử lý đơn hàng sẽ được tính từ khi nhận được thanh toán hoàn tất của quý khách.</p><p>Có thể thay đổi thời gian giao hàng nếu khách hàng yêu cầu và EGA&nbsp;Sportswear&nbsp; chủ động đổi trong trường hợp chịu ảnh hưởng của thiên tai hoặc các sự kiện đặc biệt khác.</p><p>Đơn hàng của quý khách sẽ được giao tối đa trong 2 lần. Trường hợp lần đầu giao hàng không thành công, sẽ có nhân viên liên hệ để sắp xếp lịch giao hàng lần 2 với quý khách, trong trường hợp vẫn không thể liên lạc lại được hoặc không nhận được bất kì phản hồi nào từ phía quý khách, đơn hàng sẽ không còn hiệu lực.</p><p>Để kiểm tra thông tin hoặc tình trạng đơn hàng của quý khách, xin vui lòng inbox fanpage hoặc gọi số hotline, cung cấp tên, số điện thoại để được kiểm tra.</p><p>Khi hàng được giao đến quý khách, vui lòng ký xác nhận với nhân viên giao hàng và kiểm tra lại số lượng cũng như loại hàng hóa được giao có chính xác không. Xin quý khách vui lòng giữ lại biên lại vận chuyển và hóa đơn mua hàng để đối chiếu kiểm tra.</p><p>2.&nbsp;<strong>Phí giao hàng</strong>:</p><ul><li>Phí ship cố định là 30,000đ áp dụng cho mọi khu vực</li></ul>
					</div>
									</div>
			</div>
...
<script> 
	...
	function changeContactFormBody  (sku){
		$('#comment').val(`Đăng ký nhận thông báo khi có hàng. Sản phảm: Demo coupon nhập liệu từ metafield. SKU: ${sku}`)

	}
	changeContactFormBody('Q22')
	/*For recent product*/
	var alias = 'san-pham-demo-coupon-nhap-lieu-tu-metafield';
	/*end*/
	if (ww >= 1200){
