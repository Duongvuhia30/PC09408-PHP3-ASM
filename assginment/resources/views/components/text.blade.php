                    ...
                    <div class="col-md-6">
                        <div class="iq-card-transparent iq-card-block iq-card-stretch iq-card-height">
                            <div class="iq-card-body p-0">
                                ...
                                <span
                                    class="text-dark mb-4 pb-4 iq-border-bottom d-block"></span>
                                ...
                                <div class="mb-3">
                                    <a href="javascript:void(0);" class="text-body text-center"
                                        ...
                                        <span class="avatar-30 rounded-circle bg-primary d-inline-block mr-2">
                                            <i class="main-heart-icon-ri-heart-fill"
                                                style=""></i></span><span>Thêm
                                            vào danh sách yêu
                                            thích</span></a>
                                </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="col-7">
                                    ...
                                    <div class="iq-product-action">
                                        ...
                                        <a href="javascript:void(0);" onclick="toggleFavorite()">
                                            <i class="related-heart-icon-ri-heart-fill"
                                              ></i>
                                        </a>
                                    </div>
                                </div>
